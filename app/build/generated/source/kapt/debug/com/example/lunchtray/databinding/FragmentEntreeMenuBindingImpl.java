...
public class FragmentEntreeMenuBindingImpl extends FragmentEntreeMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.entreeMenu == variableId) {
            setEntreeMenu((com.example.lunchtray.ui.order.EntreeMenuFragment) variable);
        }
    ...
    public void setEntreeMenu(@Nullable com.example.lunchtray.ui.order.EntreeMenuFragment EntreeMenu) {
        this.mEntreeMenu = EntreeMenu;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.entreeMenu);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.EntreeMenuFragment entreeMenu = mEntreeMenu;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 6: {
                ...
                com.example.lunchtray.ui.order.EntreeMenuFragment entreeMenu = mEntreeMenu;
                // entreeMenu != null
                boolean entreeMenuJavaLangObjectNull = false;



                entreeMenuJavaLangObjectNull = (entreeMenu) != (null);
                if (entreeMenuJavaLangObjectNull) {


                    entreeMenu.goToNextScreen();
                }
                break;
            }
            case 3: {
