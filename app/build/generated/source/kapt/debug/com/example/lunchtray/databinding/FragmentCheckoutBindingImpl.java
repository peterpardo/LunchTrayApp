...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.checkout == variableId) {
            setCheckout((com.example.lunchtray.ui.order.CheckoutFragment) variable);
        }
    ...
    public void setCheckout(@Nullable com.example.lunchtray.ui.order.CheckoutFragment Checkout) {
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.CheckoutFragment checkout = mCheckout;
