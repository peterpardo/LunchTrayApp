...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.accompanimentMenu == variableId) {
            setAccompanimentMenu((com.example.lunchtray.ui.order.AccompanimentMenuFragment) variable);
        }
    ...
    public void setAccompanimentMenu(@Nullable com.example.lunchtray.ui.order.AccompanimentMenuFragment AccompanimentMenu) {
        this.mAccompanimentMenu = AccompanimentMenu;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.accompanimentMenu);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.AccompanimentMenuFragment accompanimentMenu = mAccompanimentMenu;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 4: {
                ...
                boolean accompanimentMenuJavaLangObjectNull = false;
                // accompanimentMenu
                com.example.lunchtray.ui.order.AccompanimentMenuFragment accompanimentMenu = mAccompanimentMenu;



                accompanimentMenuJavaLangObjectNull = (accompanimentMenu) != (null);
                if (accompanimentMenuJavaLangObjectNull) {


                    accompanimentMenu.cancelOrder();
                }
                break;
            }
            case 2: {
            ...
            case 5: {
                ...
                if (accompanimentMenuJavaLangObjectNull) {
                    ...
                    accompanimentMenu.goToNextScreen();
                }
                break;
            }
            case 3: {
